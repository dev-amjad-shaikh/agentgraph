#!/usr/bin/env python3
"""Markdown -> DOCX converter for the Rust Agentic Core whitepaper.
...
def convert(md_path, docx_path):
    ...
    props.title = ('Rust for the Agentic Core Engine: Why Agent Orchestration '
                   'Belongs in Systems Code')
    props.author = 'agentgraph project'
    props.subject = 'Whitepaper'
